...
import xapi.bytecode.CodeAnalyzer;
...
//        int attr_len = 
    ...
    public static class RuntimeCopyException extends RuntimeException {
      private static final long serialVersionUID = -6838333960931053402L;
     ...
     * Sets <code>code[]</code>.
     */
    public void setCode(byte[] newinfo) { super.set(newinfo); }
