...
public class JUnitUi {
  ...
  private final Map<Method, Provider<Object>> tests = new LinkedHashMap<Method, Provider<Object>>();
...
//        + "\">Recompile</a>", null);
  ...
  Map<Class<?>, Map<Method, Boolean>> testResults =
      new LinkedHashMap<Class<?>, Map<Method, Boolean>>();
