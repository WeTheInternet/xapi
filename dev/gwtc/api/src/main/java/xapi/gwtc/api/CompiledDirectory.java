...
private static final long serialVersionUID = 24353247L;
  ...
  public static CompiledDirectory fromString(String encoded, Out1<CompiledDirectory> ctor) {
    CompiledDirectory compile = ctor.out1();
  ...
  public CompiledDirectory setStrategy(CompileStrategy strategy) {
    this.strategy = strategy;
    return this;
  }

  public CompileStrategy getStrategy() {
    return strategy;
  }
}
