    ...
    public void endVisit(ArrayAllocationExpression x, BlockScope scope) {
      try {
        ...
        if (x.initializer != null) {
          ...
          Collections.reverse(dims);//why not use LinkedList#addFirst?
...
//TODO(java7)
    ...
    protected <T extends JStatement> List<T> pop(Statement[] statements) {
      ...
      for (ListIterator<T> it = result.listIterator(); it.hasNext(); ++i) {
        ...
        } //TODO This is probably where we'll have to pull JClassLiterals from varargs statements...
      }
      return result;
    }
...
//      if ("newInstance".equals(intern(b.selector))) {
//        System.err.println(b.declaringClass.genericTypeSignature());
//      }
      method =
