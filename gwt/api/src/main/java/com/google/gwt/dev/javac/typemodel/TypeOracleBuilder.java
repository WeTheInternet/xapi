...
public class TypeOracleBuilder {
  ...
  protected JAnnotationType newAnnotationType(JPackage pkg,
      String enclosingTypeName, String className, String location) {
    return new JAnnotationType(typeOracle, pkg, enclosingTypeName, className, location);
  }
  ...
  protected JEnumType newEnumType(JPackage pkg, String enclosingTypeName,
    ...
    return new JEnumType(typeOracle, pkg, enclosingTypeName, className, location);
  }
  ...
  protected JRealClassType newRealClassType(JPackage pkg,
      String enclosingTypeName, String className, boolean isIntf, String location) {
