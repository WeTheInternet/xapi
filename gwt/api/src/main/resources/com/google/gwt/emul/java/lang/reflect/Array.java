...
class Array {
  ...
  /*-{
//     if (array == null)
//       @java.lang.reflect.Array::throwIllegalArg(Ljava/lang/String)();
  ...
  ;
    ...
    private static final String NOT_IMPL = "Array reflection not implemented! \n" +
    		"You must inherit wetheinter.net.XReflect for full support " +
    		"(or wetheinter.net.XReflectNoInject for annotation-only support)";
    
    private static Object newArray(Class componentType, int length)
  throws NegativeArraySizeException{
      throw new NotYetImplemented(NOT_IMPL);
    }
