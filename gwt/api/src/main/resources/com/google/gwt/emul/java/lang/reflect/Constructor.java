...
//    private Constructor<T>      root;
    ...
    public Constructor(Class<T> from, JavaScriptObject method) {
      this(from, new Class[0], new Class[0], 0,
...
//        throw new IllegalArgumentException("Cannot reflectively create enum objects");
   ...
   String getSignature() {
    ...
    public <T extends Annotation> T getAnnotation(Class<T> annotationClass) {
        ...
        return null;//(T) declaredAnnotations().get(annotationClass);
    }
    ...
    public Annotation[] getDeclaredAnnotations()  {
        return null;//AnnotationParser.toArray(declaredAnnotations());
    }
...
//          AnnotationParser.parseParameterAnnotations(
