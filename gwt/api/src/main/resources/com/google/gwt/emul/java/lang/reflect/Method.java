...
//    }
           ...
           byte[] annotationDefault)
    {
        ...
        this.signature = signature;//should be able to infer signature
    ...
    public Method(
      ...
      // We're trying to leave Method as intact as possible,
      // in the hopes we can use it to grok arbitrary bytecode structure in gwt.
      // This will come in handy for collide, which can author and compile arbitrary java. 
      this(from, name, parameterTypes, returnType, checkedExceptions, 
        modifiers, "", new byte[0], new byte[0], new byte[0]);
      this.method = method;
    }
...
//    else
  ...
  try {
     ...
     */
    @UnsafeNativeLong
    public Object invoke(Object obj, Object ... initargs)
  throws IllegalAccessException,
    ...
    /*-{
      // The method is "static", and takes obj as first parameter
      args.unshift(obj);
