...
public class UnifyAst implements UnifyAstView{
  ...
  private Map<String, MagicMethodGenerator> magicMethodMap = new HashMap<String, MagicMethodGenerator>();
  ...
  public TypeOracle getTypeOracle() {
    return getRebindPermutationOracle().getGeneratorContext().getTypeOracle();
  }
