...
public final class CompiledClass implements Serializable {
  ...
  private static final long serialVersionUID = -522865011538185836L;
...
//    CompiledClass[] orig = new CompiledClass[in.size()];
  ...
  public TypeData getTypeData() {
    if (typeData == null) {
      typeData =
          new TypeData(getPackageName(), getSourceName(), getInternalName(), unit.getResourceLocation(), getBytes(),
