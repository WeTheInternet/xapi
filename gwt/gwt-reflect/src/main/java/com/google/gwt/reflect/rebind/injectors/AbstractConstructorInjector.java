...
public abstract class AbstractConstructorInjector extends MemberGenerator implements MagicMethodGenerator {
  ...
  public JExpression injectMagic(final TreeLogger logger, final JMethodCall callSite,
    ...
    JMethodCall constructorFactory = getConstructorProvider(logger, ast, ctor, classLit, isDeclared());
  ...
  public JMethodCall getConstructorProvider(TreeLogger logger, UnifyAstView ast, 
    ...
    String factoryCls = getOrMakeConstructorFactory(logger, ast.getRebindPermutationOracle().getGeneratorContext(), ctor, ctor.getEnclosingType(), manifest, declaredOnly);
  ...
  public String getOrMakeConstructorFactory(TreeLogger logger, GeneratorContext ctx, 
      JConstructor ctor,
