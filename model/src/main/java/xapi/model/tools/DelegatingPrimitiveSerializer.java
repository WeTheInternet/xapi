...
public class DelegatingPrimitiveSerializer implements PrimitiveSerializer {
  ...
  /**
   * @see xapi.model.api.PrimitiveSerializer#deserializeBoolean(xapi.source.lex.CharIterator)
   */
  @Override
  ...
  /**
   * @see xapi.model.api.PrimitiveSerializer#deserializeBooleanArray(xapi.source.lex.CharIterator)
   */
  @Override
  ...
  /**
   * @see xapi.model.api.PrimitiveSerializer#deserializeByte(xapi.source.lex.CharIterator)
   */
  @Override
  ...
  /**
   * @see xapi.model.api.PrimitiveSerializer#deserializeShort(xapi.source.lex.CharIterator)
   */
  @Override
  ...
  /**
   * @see xapi.model.api.PrimitiveSerializer#deserializeChar(xapi.source.lex.CharIterator)
   */
  @Override
  ...
  /**
   * @see xapi.model.api.PrimitiveSerializer#deserializeInt(xapi.source.lex.CharIterator)
   */
  @Override
  ...
  /**
   * @see xapi.model.api.PrimitiveSerializer#deserializeLong(xapi.source.lex.CharIterator)
   */
  @Override
  ...
  /**
   * @see xapi.model.api.PrimitiveSerializer#deserializeFloat(xapi.source.lex.CharIterator)
   */
  @Override
  ...
  /**
   * @see xapi.model.api.PrimitiveSerializer#deserializeDouble(xapi.source.lex.CharIterator)
   */
  @Override
