...
public interface ModelService {
    ...
    <M extends Model> Out1<M> doPersistBlocking(String type, M model, long milliTimeout);

    @DoNotOverride
    default <M extends Model> M deserialize(final Class<M> cls, final CharIterator model) {
        return deserialize(cls, model, new ModelSerializationHints());
    }
    <M extends Model> M deserialize(final Class<M> cls, final CharIterator model, ModelSerializationHints hints);
    ...
    void delete(ModelKey key, SuccessHandler<Boolean> callback);
