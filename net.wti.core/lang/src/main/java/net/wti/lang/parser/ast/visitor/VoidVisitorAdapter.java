...
public abstract class VoidVisitorAdapter<A> implements VoidVisitor<A> {
	...
	@Override public void visit(final TemplateLiteralExpr n, final A arg) {
		visitComment(n.getComment(), arg);
	}
  ...
  @Override
  public void visit(DynamicDeclarationExpr n, A arg) {
    if (n.getBody() != null) {
      n.getBody().accept(this, arg);
    }
  }
  ...
  public void visit(CssSelectorExpr n, A arg) {
	...
	@Override
	public void visit(SysExpr sysExpr, A arg) {
		sysExpr.nodes().forEach(
			sysExpr.voidVisit(this, arg)
				.provide1(this)
				.provide2(arg)
				::in
		);
