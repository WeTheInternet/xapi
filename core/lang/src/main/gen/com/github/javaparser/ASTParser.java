...
{if ("" != null) return ret;}
  ...
  private boolean jj_3R_116()
 {
  ...
  private int jj_gen;
  final private int[] jj_la1 = new int[230];
  ...
  public ASTParser(java.io.InputStream stream, String encoding) {
	 ...
	 jj_ntk = -1;
	 jj_gen = 0;
	 for (int i = 0; i < 230; i++) jj_la1[i] = -1;
