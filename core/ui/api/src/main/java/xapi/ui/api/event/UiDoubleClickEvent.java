 ...
 */
public interface UiDoubleClickEvent<Payload, Node, Ui extends UiElement<Node, ? extends Node, Ui>> extends UiEvent<Payload, Node, Ui> {

    @Override
    default IsEventType getType() {
        return EventTypes.DoubleClick;
    }
