...
public interface TimeService extends Moment{
    ...
    /**
     * Breaks down epoch milliseconds into components for the given timezone.
     * @param epochMillis milliseconds since epoch
     * @param zone timezone information
     * @return time components (year, month, day, hour, minute, second, etc.)
     */
    TimeComponents breakdown(double epochMillis, TimeZoneInfo zone);

    /**
     * @return the system's default timezone information
     */
    TimeZoneInfo systemZone();
    ...
    /**
     * Returns the start of the week (Sunday 00:00) for the given moment.
     * @param epochMillis milliseconds since epoch
     * @param zone timezone to use
     * @return milliseconds of week start
     */
    double toStartOfWeek(double epochMillis, TimeZoneInfo zone);
}
