...
@Gwtc(
  ...
  ,dependencies={
    ...
    @Dependency(dependencyType=DependencyType.MAVEN,
      groupId="net.wetheinter", value="xapi-gwtc-compiler",version=X_Namespace.XAPI_VERSION),
    @Dependency(dependencyType=DependencyType.MAVEN,
      // we should not have to declare this classifier'ed dependency, yet, we do...
      groupId="net.wetheinter", value="xapi-gwtc-compiler",version=X_Namespace.XAPI_VERSION, classifier = "sources"),
    @Dependency(dependencyType=DependencyType.MAVEN,
