 ...
 * <p>
 * Can be applied to packages, classes and specific fields.
 * <p>
 ...
 */
@Documented
@Target(value= {CONSTRUCTOR, TYPE, PACKAGE})
...
public @interface KeepConstructor {
   ...
   * as possible in log messages, including parameter type debug data.
   */
