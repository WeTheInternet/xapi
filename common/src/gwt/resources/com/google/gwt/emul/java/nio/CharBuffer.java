 ...
 * <li>Use {@link java.nio.ByteBuffer#asCharBuffer() ByteBuffer.asCharBuffer} to create a char
...
//    }
     ...
     * <p> The remaining chars will be moved to the head of the buffer, starting from position
     ...
     * <p> The duplicated buffer's initial position, limit, capacity and mark are the same as this
     ...
     * <p> If {@code other} is not a char buffer then {@code false} is returned. Two char buffers
     ...
     * by the number of chars written. <p> Calling this method has the same effect as {@code
     ...
     * <p> Calling this method has the same effect as {@code put(str, 0, str.length())}. </p>
     *
     ...
     * property and byte order are same as this buffer. </p>
     * <p> The new buffer shares its content with this buffer, which means either buffer's change
     * of content will be visible to the other. The two buffer's position, limit and mark are
     * independent. </p>
     *
     ...
     * content.
     * <p> The new buffer's position will be {@code position() + start}, limit will be {@code
     * position() + end}, capacity will be the same as this buffer. The new buffer's read-only
     * property and byte order are the same as this buffer. </p>
     * <p> The new buffer shares its content with this buffer, which means either buffer's change
     * of content will be visible to the other. The two buffer's position, limit and mark are
     * independent. </p>
     *
     ...
     * <p> Calling this method has the same effect as {@code append(csq.toString())}. </p>
