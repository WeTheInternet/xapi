...
public class TreeLogger {
  ...
  public static final TreeLogger NULL = new TreeLogger() {
    ...
    public boolean isLoggable(Type type) {
      return SuperTreeLogger.isLoggable(this, type);
    }
   ...
   */
  public TreeLogger branch(TreeLogger.Type type, String msg,
      Throwable caught, HelpInfo helpInfo){
    return SuperTreeLogger.branch(this, type, msg, caught, helpInfo);
  };
  ...
  public void log(TreeLogger.Type type, String msg, Throwable caught,
      HelpInfo helpInfo){
    //Bounce our log events out of the supersource package so this class can live in a jar, but be extensible
    SuperTreeLogger.log(this, type, msg, caught, helpInfo);
  }
}
