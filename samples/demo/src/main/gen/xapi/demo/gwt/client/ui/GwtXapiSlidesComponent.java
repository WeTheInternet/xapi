...
public class GwtXapiSlidesComponent extends BaseXapiSlidesComponent<Element, PotentialNode<Element>> implements
    ElementalModelComponentMixin<Element,ModelXapiSlides> {
