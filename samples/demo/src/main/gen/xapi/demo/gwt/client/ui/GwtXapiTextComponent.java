...
public class GwtXapiTextComponent extends BaseXapiTextComponent<Element, PotentialNode<Element>> implements
    ElementalModelComponentMixin<Element,ModelXapiText> {
